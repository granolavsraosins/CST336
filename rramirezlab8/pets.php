        ...
        $(".petLink").click(function(){
            ...
            $.ajax({
                ...
                complete: function(data,status){
                    //used for debugging purposes alert(status);
                }
            });//ajax
        });//.petLink click
    });//document.ready
...
<?php
    ...
    foreach ($pets as $pet){
        ...
        echo "<button id='".$pet['id']."'type='button' class='btn btn-primary perLink'>Adopt Me!</button>";
        echo "<hr><br>";
    }
?>
<!-- Trigger the modal with a button -->
<div class="modal fade" id="petInfoModal" tabindex="-1"role="dialog"aria-labelledby="exampleModalLabel"
    aria-hidden="true">
