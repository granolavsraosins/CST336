...
function WebGLGeometryJSON(gl) {
	...
	this.create = function(jsonFileData, rawImage) {
        ...
        if (rawImage) {
            ...
            // todo 4 bind the texture
            this.gl.bindTexture(gl.TEXTURE_2D,this.texture);//binds WebGl texture object to given target
            
            // needed for the way browsers load images, ignore this
            this.gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true);//specifies pixel storage modes
            
            // todo set wrap modes (for s and t) for the texture
            //the i at the end of parameter sets texture parameters
