...
function initGL(canvas) {
    ...
    try {
        ...
        gl.enable(gl.DEPTH_TEST);//hidden surface removal tests depth of each object
        // todo enable backface culling
        gl.enable(gl.CULL_FACE);//increases drawing speed
    } catch (e) {}
...
function updateAndRender() {
    ...
    // todo 8 - enable blending
    gl.enable(gl.BLEND);//alpha blending enabled pg 380
    ...
    gl.depthMask(false);//pg 385 draw objects while turning hidden surface removal on and off.
    //todo 6 implement spheres webgl.geometry.js needs to have same code as quad.
    ...
    gl.disable(gl.BLEND);
    gl.depthMask(true);//depth buffer is readable and writeable. 
}
